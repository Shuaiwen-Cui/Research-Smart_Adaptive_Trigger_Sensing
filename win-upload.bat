...
@REM git push -f https://github.com/Shuaiwen-Cui/Research-Smart_Adaptive_Trigger_Sensing.git main
git push -f https://github.com/Shuaiwen-Cui/Research-Smart_Adaptive_Trigger_Sensing.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Research-Smart_Adaptive_Trigger_Sensing.git
